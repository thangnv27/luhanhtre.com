...
// Don't duplicate me!
if ( !class_exists( 'Radium_Theme_Demo_Data_Importer' && class_exists( 'Radium_Theme_Importer' ) ) ) {
	class Radium_Theme_Demo_Data_Importer extends Radium_Theme_Importer {
		...
		public function initSettings() {
			...
			if ( isset( $this->active_import_id ) && !empty( $this->active_import_id ) ) {
				...
				$demo_import_array = $this->parent->data_import_files[$this->active_import_id];

				$this->theme_options_file_name = ( isset( $demo_import_array['theme_options'] ) ) ? $demo_import_array['theme_options'] : '';

				$this->setting_file_name = ( isset( $demo_import_array['setting'] ) ) ? $demo_import_array['setting'] : '';
		...
		public function set_demo_menus() {
			do_action( 'demo_importer_before_widget_import', $this->active_import, $this->demo_files_path );
		}
