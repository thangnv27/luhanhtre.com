...
<head>
<meta name="google-site-verification" content="CqqIT-lvldvx5Ef9GeWYwEO7sGrakvUSdAxGyjpoOPA" />
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-115098703-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-115098703-1');
</script>
